...
for i in $(seq 1 30)
do
    RESULT=$(taskset -c 0-3 sysbench cpu --cpu-max-prime=20000 run)
...
# No Power Shell:
# rodar "wsl"
# rodar "chmod +x scripts/cpu/run_sysbench_taskset.sh"
# rodar "./scripts/cpu/run_sysbench_taskset.sh output.csv"